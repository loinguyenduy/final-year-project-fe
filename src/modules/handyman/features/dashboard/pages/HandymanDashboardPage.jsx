...
import { FaFileAlt, FaCheckCircle, FaClock, FaExclamationTriangle, FaShieldAlt, FaLock } from 'react-icons/fa';
            ...
            <div className="bonding-block shadow-sm">
                ...
                <div className="security-note">
                    ...
                    <p>
                        ...
                        The security bond is stored in a separate Escrow Wallet and is used solely to guarantee job quality. 
                        You can withdraw this amount if you decide to stop working on the platform.
                    </p>
                </div>
            </div>
        );
    ...
    const renderC3OfficialDashboard = () => {
        return (
            <div className="c3-placeholder">
                ...
                <p className="text-muted">You have successfully bonded and unlocked all features.<br/>(The full dashboard UI will be implemented in the next step)</p>
            </div>
        );
    };
